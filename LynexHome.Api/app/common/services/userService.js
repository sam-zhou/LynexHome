common.factory('userService', [
    "$cookies", "$rootScope", "$http", '$q', '$location', 'toolService', 'apiService', '$window', 'dataStorageService',
    function($cookies, $rootScope, $http, $q, $location, tools, api, $window, dataStorageService) {
        ...
        function setUser(data) {
            ...
            dataStorageService.initForUser(self.user.userId);
        }
