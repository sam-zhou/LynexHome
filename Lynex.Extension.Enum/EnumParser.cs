...
namespace Lynex.Extension.Enum
{
	...
	internal class EnumParser
	{
		...
		public IEnumerable<LookupValue> GetLookupValues(Type lookup)
		{
			...
			foreach (System.Enum value in System.Enum.GetValues(lookup))
			{
		...
		/// split into words.
		/// </summary>
		private string EnumName(System.Enum value)
		{
		...
		/// </summary>
		private static string EnumDescriptionValue(System.Enum value)
		{
		...
		private static bool IsRuntimeOnly(System.Enum value)
		{
			var enumType = value.GetType();
